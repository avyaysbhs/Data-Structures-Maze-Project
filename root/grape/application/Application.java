...
public class Application {
    ...
    public static @interface Configurations 
    {
        ...
        WindowConfigurations Window() default @WindowConfigurations(
    ...
    public void passConfigurations(Configurations config)
    {
        if (configurations == null) {
            ...
            _window = new Window(config.Window().Dimensions().X(), config.Window().Dimensions().Y(), config.Window().Resizable());
